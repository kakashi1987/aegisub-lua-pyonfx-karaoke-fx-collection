...
script_name = "Aegisub Effect 32"
script_author = "Spyne21"
script_version = "1.1"

--Function fx32--
function fx32(subs, config, index)
...
function do_fx(subs, meta, line, config)
	...
	for i = 1, line.kara.n do		--text hilight_2
		local syl = line.kara[i]
		if syl.duration > 0 then
			local l = table.copy(line)
			if config.color_rand_middle_2 == true then config.primary_color_middle_2 = ass_color(math.random(255),math.random(255),math.random(255)) end
			if config.color_outline_rand_middle_2 == true then config.outline_color_middle_2 = ass_color(math.random(255),math.random(255),math.random(255)) end
			if config.color_shadow_rand_middle_2 == true then config.shadow_color_middle_2 = ass_color(math.random(255),math.random(255),math.random(255)) end
			l.start_time=line.start_time+syl.start_time
			l.end_time=line.start_time+syl.end_time
			l.text=string.format("{\\an5\\1c%s\\3c%s\\4c%s\\1a%s\\3a%s\\4a%s\\bord%0.3f\\shad%0.3f\\blur%0.3f\\pos(%d,%d)\\fad(0,200)\\t(\\fscx150\\fscy150)}%s",config.primary_color_middle_2, config.outline_color_middle_2, config.shadow_color_middle_2, config.primary_alpha_middle_2, config.outline_alpha_middle_2, config.shadow_alpha_middle_2, config.outline_middle_2, config.shadow_middle_2,config.blur_middle_2,line.left+syl.center,line.middle,syl.text_stripped)
			l.layer=2
			subs.append(l)
		end
	end
...
aegisub_karaoke_conf = {
	...
	,
	[16] = { class = "label"; x = 0; y = 22; height = 1; width = 1; label = "Text Color End" }
	,
	[17] = { class = "label"; x = 1; y = 21; height = 1; width = 1; label = "Primary"}
	,
	[18] = { name = "primary_color_end"; class = "color"; x = 1; y = 22; height = 2; width = 1; value =  "#FFFFFF" }
	,
	[19] = { class = "label"; x = 2; y = 21; height = 1; width = 1; label = "Outline"}
	,
	[20] = { name = "outline_color_end"; class = "color"; x = 2; y = 22; height = 2; width = 1; value = "#000000" }
	,
	[21] = { class = "label"; x = 3; y = 21; height = 1; width = 1; label = "Shadow"}
	,
	[22] = { name = "shadow_color_end"; class = "color"; x = 3; y = 22; height = 2; width = 1; value = "#000000" }
	,
	[23] = { class = "label"; x = 0; y = 24; height = 1; width = 1; label = "Text Alpha End" }
	,
	[24] = { name = "primary_alpha_end"; class = "alpha"; x = 1; y = 24; height = 1; width = 1; value =  "#00" }
	,
	[25] = { name = "outline_alpha_end"; class = "alpha"; x = 2; y = 24; height = 1; width = 1; value = "#00" }
	,
	[26] = { name = "shadow_alpha_end"; class = "alpha"; x = 3; y = 24; height = 1; width = 1; value = "#00" }	
	,
	...
	,
	[34] = { class = "label"; x = 0; y = 26; height = 1; width = 1; label = "Outline End" }
	,
	[35] = { class = "label"; x = 1; y = 25; height = 1; width = 1; label = "Outline" }
	,
	[36] = { name = "outline_end"; class = "floatedit" ; x = 1; y = 26; height = 1; width = 1; min = 0; value = 2 }
	,
	[37] = { class = "label"; x = 2; y = 25; height = 1; width = 1; label = "Shadow" }
	,
	[38] = { name = "shadow_end"; class = "floatedit" ; x = 2; y = 26; height = 1; width = 1; min = 0; value = 0 }
	,
	[39] = { class = "label"; x = 3; y = 25; height = 1; width = 1; label = "Blur" }
	,
	[40] = { name = "blur_end" ; class = "floatedit" ; x = 3; y = 26; height = 1; width = 1; min = 0; value = 0}
	,
	...
	,
	[60] = { class = "label"; x = 0; y = 27; height = 1; width = 1; label = "Color Primary Random : " }
	,
	[61] = { name = "color_rand_start" ; class = "checkbox" ; x = 0; y = 28; height = 1; width = 1; label = "Color Start"; value = false}
	,
	[62] = { name = "color_rand_middle" ; class = "checkbox" ; x = 1; y = 28; height = 1; width = 1; label = "Color Middle"; value = false}
	,
	[63] = { name = "color_rand_middle_2" ; class = "checkbox" ; x = 2; y = 28; height = 1; width = 1; label = "Color Middle 2"; value = false}
	,
	[64] = { name = "color_rand_end" ; class = "checkbox" ; x = 3; y = 28; height = 1; width = 1; label = "Color End"; value = false}
	,
	[65] = { class = "label"; x = 0; y = 29; height = 1; width = 1; label = "Color Outline Random : " }
	,	
	[66] = { name = "color_outline_rand_start" ; class = "checkbox" ; x = 0; y = 30; height = 1; width = 1; label = "Color Outline Start"; value = false}
	,
	[67] = { name = "color_outline_rand_middle" ; class = "checkbox" ; x = 1; y = 30; height = 1; width = 1; label = "Color Outline Middle"; value = false}
	,
	[68] = { name = "color_outline_rand_middle_2" ; class = "checkbox" ; x = 2; y = 30; height = 1; width = 1; label = "Color Outline Middle 2"; value = false}
	,
	[69] = { name = "color_outline_rand_end" ; class = "checkbox" ; x = 3; y = 30; height = 1; width = 1; label = "Color Outline End"; value = false}
	,
	[70] = { class = "label"; x = 0; y = 31; height = 1; width = 1; label = "Color Shadow Random : " }
	,	
	[71] = { name = "color_shadow_rand_start" ; class = "checkbox" ; x = 0; y = 32; height = 1; width = 1; label = "Color Shadow Start"; value = false}
	,
	[72] = { name = "color_shadow_rand_middle" ; class = "checkbox" ; x = 1; y = 32; height = 1; width = 1; label = "Color Shadow Middle"; value = false}
	,
	[73] = { name = "color_shadow_rand_middle_2" ; class = "checkbox" ; x = 2; y = 32; height = 1; width = 1; label = "Color Shadow Middle 2"; value = false}
	,
	[74] = { name = "color_shadow_rand_end" ; class = "checkbox" ; x = 3; y = 32; height = 1; width = 1; label = "Color Shadow End"; value = false}
	,
	[75] = { class = "label"; x = 0; y = 16; height = 1; width = 1; label = "Text Color Middle 2" }
	,
	[76] = { class = "label"; x = 1; y = 15; height = 1; width = 1; label = "Primary"}
	,
	[77] = { name = "primary_color_middle_2"; class = "color"; x = 1; y = 16; height = 2; width = 1; value =  "#FFFFFF" }
	,
	[78] = { class = "label"; x = 2; y = 15; height = 1; width = 1; label = "Outline"}
	,
	[79] = { name = "outline_color_middle_2"; class = "color"; x = 2; y = 16; height = 2; width = 1; value = "#000000" }
	,
	[80] = { class = "label"; x = 3; y = 15; height = 1; width = 1; label = "Shadow"}
	,
	[81] = { name = "shadow_color_middle_2"; class = "color"; x = 3; y = 16; height = 2; width = 1; value = "#000000" }
	,
	[82] = { class = "label"; x = 0; y = 18; height = 1; width = 1; label = "Text Alpha Middle 2" }
	,
	[83] = { name = "primary_alpha_middle_2"; class = "alpha"; x = 1; y = 18; height = 1; width = 1; value =  "#00" }
	,
	[84] = { name = "outline_alpha_middle_2"; class = "alpha"; x = 2; y = 18; height = 1; width = 1; value = "#00" }
	,
	[85] = { name = "shadow_alpha_middle_2"; class = "alpha"; x = 3; y = 18; height = 1; width = 1; value = "#00" }	
	,
	[86] = { class = "label"; x = 0; y = 20; height = 1; width = 1; label = "Outline Middle 2" }
	,
	[87] = { class = "label"; x = 1; y = 19; height = 1; width = 1; label = "Outline" }
	,
	[88] = { name = "outline_middle_2"; class = "floatedit" ; x = 1; y = 20; height = 1; width = 1; min = 0; value = 2 }
	,
	[89] = { class = "label"; x = 2; y = 19; height = 1; width = 1; label = "Shadow" }
	,
	[90] = { name = "shadow_middle_2"; class = "floatedit" ; x = 2; y = 20; height = 1; width = 1; min = 0; value = 0 }
	,
	[91] = { class = "label"; x = 3; y = 19; height = 1; width = 1; label = "Blur" }
	,
	[92] = { name = "blur_middle_2" ; class = "floatedit" ; x = 3; y = 20; height = 1; width = 1; min = 0; value = 0}
} 
aegisub_karaoke_conf_key = {2,4,7,9,11,13,14,15,18,20,22,24,25,26,29,31,33,36,38,40,44,46,48,50,51,52,55,57,59,61,62,63,64,66,67,68,69,71,72,73,74,77,79,81,83,84,85,88,90,92}
...
function aegisub_karaoke_macro(subtitles, selected_lines, active_line)
	...
	if cfg_res == "OK" then		
		...
		config.primary_color_middle_2 = asscolor(config.primary_color_middle_2)
		config.outline_color_middle_2 = asscolor(config.outline_color_middle_2)
		config.shadow_color_middle_2 = asscolor(config.shadow_color_middle_2)
		config.primary_alpha_middle_2 = assalpha(config.primary_alpha_middle_2)
		config.outline_alpha_middle_2 = assalpha(config.outline_alpha_middle_2)
		config.shadow_alpha_middle_2 = assalpha(config.shadow_alpha_middle_2)
...
aegisub.register_macro("Aegisub Effect 32","",aegisub_karaoke_macro)