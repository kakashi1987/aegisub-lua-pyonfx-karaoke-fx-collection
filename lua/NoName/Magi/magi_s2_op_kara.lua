	...
	if line.style == "OP Romaji" or line.style == "ED Romaji" then
		...
		for si,syl in ipairs(line.syls) do
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord1\\blur1.2\\shad0\\fscx100\\fscy100\\1c&HF6F8F8&\\3c&H257488&\\fad(250,0)\\pos(%.3f, %.3f)}%s"
			...
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord1.5\\blur4\\shad0\\fscx100\\fscy100\\1c&HB1F0FA&\\3c&HB1F0FA&\\fad(250,0)\\pos(%.3f, %.3f)}%s"
				,syl.center,syl.middle,syl.text)
			...
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord1\\blur1.2\\shad0\\fscx155\\fscy155\\t(\\fscx100\\fscy100)\\1c&HF6F8F8&\\3c&H257488&\\pos(%.3f, %.3f)}%s"
				,syl.center,syl.middle,syl.text)
			...
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord3.5\\blur8\\shad0\\fscx165\\fscy165\\t(\\bord1.5\\blur4\\fscx100\\fscy100)\\1c&HB1F0FA&\\3c&HB1F0FA&\\pos(%.3f, %.3f)}%s"
				,syl.center,syl.middle,syl.text)
			...
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord1\\blur1.2\\shad0\\fscx100\\fscy100\\1c&HF6F8F8&\\3c&H257488&\\fad(0,250)\\pos(%.3f, %.3f)}%s"
				,syl.center,syl.middle,syl.text)
			...
			if syl.text~="" then
				...
				l.text = string.format("{\\an5\\bord1.5\\blur4\\shad0\\fscx100\\fscy100\\1c&HB1F0FA&\\3c&HB1F0FA&\\fad(0,250)\\pos(%.3f, %.3f)}%s"
				,syl.center,syl.middle,syl.text)
