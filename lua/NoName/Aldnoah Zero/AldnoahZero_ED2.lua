	...
	for ci,char in ipairs(line.chars) do
		...
		if line.actor == "block" then
			...
			if char.text~="" and char.text~=" " and char.text~="　" then
				...
				text_split_large = shape.split(text_shape, 100)
			...
			if char.text~="" and char.text~=" " and char.text~="　" then
				...
				for s, e, i, n in utils.frames(line.start_time - line.infade + 15*char.i-15, line.end_time + line.outfade + 15*char.i-15 - 20*#line.chars, max_frame) do
