...
l.text = "{"..estilo(3,line.styleref.color1)..alpha(rand(20,150))..bord(1)..blur(3)..color(1,'H767575')..bord(0.1)..an(5)..fad(100,200)..move(x+rand(1),y+rand(0),x-rand(1),y-rand(0))..fscx(200,100)..fscy(200,100)..t(color(1,rand_color)).."}"..p(2,'m 0 150 l 5 130 l 4 10 l 5 0 l 10 0 l 25 5 l 26 0 l 4 -10 l 2 -45 l 3 -50 l 0 -55 l -3 -50 l -2 -45 l -4 -10 l -26 0 l -25 5 l -10 0 l -5 0 l -4 10 l -5 130  ')
l.end_time=l.start_time+syl.duration+rand(1,10)
l.start_time=line.start_time+syl.start_time+rand(200,400)
l.layer=11
subs.append(l)
end
