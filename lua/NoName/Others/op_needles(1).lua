...
l = table.copy(line)
for j = 1,20 do --serian 1 estrellas
	l.text = "{"..an(5)..color(1,'2fffff1')..move(x,y,x+rand(120),y-rand(30))..frz(-160)..fscxy(10)..bord(2)..t(fscxy(50)..alpha('ff'))..blur(3).."}"..p(1,Formas(4,1))
