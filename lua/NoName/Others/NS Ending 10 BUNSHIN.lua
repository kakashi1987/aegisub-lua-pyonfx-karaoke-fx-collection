...
l = table.copy(line)
for j= 0,1 do 
l.text = "{"..an(5)..pos(x,y)..color(1,RandomColor())..t(fscxy(300)..color(1,RandomColor())..alpha('ff')).."}"..p(4,"m 50 0 b 100 0 100 100 50 100 b 0 100 0 0 50 0 ")
...
--FX DE SILABAS(ESTE SE AGRANDA LA SILABA)
l = table.copy(line)
l.text = "{"..an(5)..pos(x,y)..color(1,RandomColor())..bord(1)..t(fscxy(100)..color(1,RandomColor())..alpha('ff')).."}"..sil()
l.start_time=line.start_time+syl.start_time
l.end_time=l.start_time+syl.duration
l.layer = 2
subs.append(l)
