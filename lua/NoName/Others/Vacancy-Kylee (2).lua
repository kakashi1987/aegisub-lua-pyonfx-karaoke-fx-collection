--[[Copyright © 2009  Alex Flechas (nickle) <mpsmaniaco@gmail.com>
...
Este programa es software libre y usted puede redistribuirlo conforme a ciertas condiciones]]
...
return RESULTADO 
			...
			elseif actor=="2" or actor=="22" then --Traduccion
				...
				if actor=="2" then
					...
					str="{"..an(5)..move(x,y,x,453,1830,2630)..fad(0,400)..bord(0)..color(1,line.styleref.color1).."}"..sil()
				end
