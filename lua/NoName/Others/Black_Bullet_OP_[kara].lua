...
ass.load("J:\\AmberdrakeSubs\\Hatsuyuki\\Black Bullet\\06\\Black Bullet 06 OP.ass")
...
local function infade_L1(ctx, ms, line)
	...
	for si, syl in ipairs(line.syls) do
		if ms >= line.start_time-line.infade and ms < line.start_time and syl.text ~= "" then
			...
			local pic = g2d.create_image_from_png("J:\\AmberdrakeSubs\\Hatsuyuki\\Black Bullet\\05\\pattern.png")
