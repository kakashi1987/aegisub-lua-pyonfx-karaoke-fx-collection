...
for r=0,1 do 
   ...
   l.text = "{"..fad(100,100)..an(5)..bord(0)..org(x,y)..move(posx+rand(5),posy+rand(5),posx1+rand(25)-100,posy1+rand(25)+20)..color(1, RandomColor())..frz(0).."}"..p(1,Formas(14,2))
...
aegisub.register_macro("Test", "APLICAR EFECTO", FORMAS_FX)
aegisub.register_filter("Test", "APLICAR EFECTO", 2000, FORMAS_FX)
