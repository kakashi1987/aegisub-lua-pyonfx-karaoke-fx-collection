...
for z=0,360 do
 angulo=math.rad(z)
 genParabola(x,y,15,angulo,1)
 l.start_time=line.start_time+syl.start_time
 l.end_time=l.start_time+syl.duration
 l.text="{"..an(5)..pos(posx,posy)..color(1,line.styleref.color2)..frx(150)..frx(150)..bord(0).."}"..p(1,'m 0 0 l 1 0 1 1  0 1')
 subs.append(l)
end
...
aegisub.register_macro("Gen Elipse FX!", "Aplica tu FX! D:", fx_zheo)
aegisub.register_filter("Gen Elipse FX!", "Aplica tu FX! D:", 2000, fx_zheo)
