...
--FX DE SILABAS
l = table.copy(line)
l.text = "{"..an(5)..pos(x,y)..color(1,line.styleref.color1)..t(fscxy(175,175)..alpha('ff')).."}"..sil()
...
l = table.copy(line)
	for j = 1 ,7 do
l.text = "{"..an(5)..move(x,y,x-rand(0,70),y-rand(0,40))..color(3,"FFFFFF")..blur(2)..bord(1)..color(1,line.styleref.color2)..fscxy(150,150)..RangeColor(1, j/7, 'CECECE', 'FFFFFF')..t(be(1)..alpha('ff')).."}"..p(2,Formas(2,2))
l.start_time= line.start_time+syl.start_time
...
l = table.copy(line)
		for j = 1 ,7 do
l.text = "{"..an(5)..move(x,y,x-rand(50,80),y+rand(40,60))..color(3,"FFFFFF")..blur(0)..bord(0)..color(1,line.styleref.color2)..fscxy(150,150)..RangeColor(1, j/7, 'CECECE', 'FFFFFF')..t(be(1)..alpha('ff')).."}"..p(3,Formas(4,2))
l.start_time= line.start_time+syl.start_time
l.end_time= l.start_time+syl.duration+math.random(200,800)     
l.layer = 25
subs.append(l)
...
l = table.copy(line)
		for j = 1 ,7 do
l.text = "{"..an(5)..move(x,y,x+rand(0,70),y+rand(0,40))..color(3,"FFFFFF")..blur(0)..bord(0)..color(1,line.styleref.color2)..fscxy(150,150)..RangeColor(1, j/7, 'CECECE', 'FFFFFF')..t(be(1)..alpha('ff')).."}"..p(3,Formas(4,2))
l.start_time= line.start_time+syl.start_time
l.end_time= l.start_time+syl.duration+math.random(200,800)     
l.layer = 20
subs.append(l)
