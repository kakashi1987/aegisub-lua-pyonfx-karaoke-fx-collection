...
l.text = "{"..an(5)..pos(x,y)..estilo(1,line.styleref.color2)..alfa(3,'ff')..t(fscxy(50,50)..alpha('ff')).."}"..sil()
...
l.text = "{"..an(5)..pos(x,y)..estilo(1,line.styleref.color2)..alfa(1,'ff')..t(fscxy(150,150)..alpha('ff')).."}"..sil()
l.start_time=line.start_time+syl.start_time
l.end_time=l.start_time+syl.duration
l.layer = 2
subs.append(l)
...
aegisub.register_macro("BUBBLE V2!", "Aplica tu FX! D:", fx_zheo)
aegisub.register_filter("BUBBLE V2!", "Aplica tu FX! D:", 2000, fx_zheo)
