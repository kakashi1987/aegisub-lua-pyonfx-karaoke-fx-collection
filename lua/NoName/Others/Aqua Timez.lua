...
script_name = "-GxF- Aqua Timez - ALONE-FX-"
script_description = "Kirav751----> Para el PV Aqua Timez - ALONE"
...
l = table.copy(line)
for j = 0,0 do
l.text = string.format("{\\fad(150,0)\\bord2\\be5\\fscx90\\fscy110\\an5\\move(%d,%d,%d,%d)\\1c%s}%s",x,y,x-math.random(-10,10),y-math.random(-10,10),line.styleref.color1,syl.text_stripped)
...
aegisub.register_macro("-GxF- -FX-", "Kirav751 ^^", kirav751_FX)
aegisub.register_filter("-GxF- -FX-", "Kirav751 ^^", 2000, kirav751_FX)
