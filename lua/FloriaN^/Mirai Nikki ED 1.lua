...
script_name = "Mirai Nikki Ending 1"
...
function anime(subs)
	...
	while i <= maxi do
		...
		local l = subs[i]
		if l.class == "dialogue" and l.style ~= "ED-eng" and
				not l.comment then
...
aegisub.register_macro("Mirai Nikki Ending 1","", macro_MF)
aegisub.register_filter("Mirai Nikki Name Ending 1","",2000,anime)