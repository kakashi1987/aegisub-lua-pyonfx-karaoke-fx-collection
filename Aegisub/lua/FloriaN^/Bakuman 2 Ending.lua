...
local l = table.copy(line)
	...
	if line.duration > 0 then
		...
		--Template
		l.text=string.format("{\\an5\\pos(%d,%d)\\fad(%d,%d)}%s",charx,chary,0,300,char)
...
aegisub.register_macro("Bakuman 2 ED","", macro_MF)

aegisub.register_filter("Bakuman 2 ED","",2000,baku)