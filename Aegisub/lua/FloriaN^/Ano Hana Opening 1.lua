...
script_name = "Ano hana Opening 1"
...
function macro_MF(subs, sel)
	...
	ano(subs, {ismacro=true, sel=sel})

end	

aegisub.register_macro("Ano Hana Opening","", macro_MF)

aegisub.register_filter("Ano Hana Opening","",2000,ano)