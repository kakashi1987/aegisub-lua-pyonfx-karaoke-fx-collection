function romaji(line, l)
	for si, syl in ipairs(line.syls) do
		...
		if syl.text~="" then
			...
			l.text = string.format("{\\an5\\bord1\\shad0\\blur2\\1c&H3A3AFF&\\3c&H0E0FB2&\\fscx100\\fscy100\\move(%.3f,%.3f,%.3f,%.3f)\\t(%d,%d,\\1c&H000000&\\fscx120\\fscy120)\\t(%d,%d,\\1c&H3A3AFF&\\fscx100\\fscy100)}%s"
