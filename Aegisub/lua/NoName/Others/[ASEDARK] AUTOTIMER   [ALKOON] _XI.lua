...
--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
	...
	l.start_time = line.start_time -500 +univers
	l.end_time = line.start_time+univers
	l.layer=0 
	subs.append(l) 

		l = table.copy(line)
		l.text = "{"..an(5)..pos(x,y)..estilo(1,line.styleref.color2)..bord(1)..AutoTimer(TE3,500,'frx',20+syl.height/2,0.5,1).."}"..sil() --# OR #--{{~ AutoTimer(TE4,500,'frx',20+line.duration,0.5,1)
	...
	l = table.copy(line)
	l.text = "{"..an(5)..shad(0)..fad(0,100)..bord(1)..pos(x,y)..color(1,'HFFFFFF')..color(3,'HFFFFFF')..estilo(1,line.styleref.color4)..AutoTimer(TE3,500,'frx',20+syl.height/2,0.5,1).."}"..sil()
	l.start_time=line.start_time+syl.start_time+syl.duration
	l.end_time=l.end_time+univers+20
	subs.append(l)
	univers=univers+(500/line.kara.n)
