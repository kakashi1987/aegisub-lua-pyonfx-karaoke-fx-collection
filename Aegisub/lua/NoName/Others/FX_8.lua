...
if i == 1 then uae =0
	...
	l.text = string.format("{\\an5\\pos(%d,%d)\\fad(100,200)\\bord1\\shad0\\blur3\\1c&FFFFFF&\\3c&HBA7921&\\t(\\fscx105\\fscy125)}%s",x,y,syl.text_stripped)
	l.layer=2
	subs.append(l)
	local l = table.copy(line)
	l.start_time=line.start_time+syl.start_time
	l.end_time=l.start_time+syl.duration
	l.text = string.format("{\\an5\\pos(%d,%d)\\fad(450,450)\\bord1\\shad0\\blur2\\3c&HFDF4D8&\\t(\\xbord10)}%s",x,y,syl.text_stripped)
	l.layer=2
	subs.append(l)
