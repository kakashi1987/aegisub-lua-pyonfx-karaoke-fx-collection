...
cx2 = 640
cy2 = 5+j*1+2
l.text = "{"..fad(100,0)..an(5)..pos(x,y)..clip(cx1, cy1, cx2, cy2)..RangeAlpha(1, j/syl.height,'00', 'ff')..RangeAlpha(3, j/syl.height,'00', 'ff')..color(1, line.styleref.color2)..bord(0)..t(bord(1)).."}"..sil()
