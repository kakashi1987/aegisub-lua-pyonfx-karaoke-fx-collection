...
elseif actor=='voz2' then -- PARA EL ACTOR voz2
		...
		l = table.copy(line)
		l.text = "{"..pos(x,y)..move(x-rand(10,20),y+rand(7,12),x,y).."}"..sil()
		l.start_time=l.start_time+syl.start_time
		l.end_time=l.start_time+syl.duration
		l.layer = 1
		subs.append(l)
...
elseif actor=='3' then --PARA EL ACTOR 3
		...
		--FX PARTICULAS
		for i = 1,40 do
		colores ={'6BAAC7', ' 295E76', '6BA9C8'}
		rand_color= colores[math.random(1,3)]
		l.text = "{"..alpha(rand(-20,250))..bord(0.1)..blur(5)..fad(100,200)..move(x,y,x-rand(26),y+rand(15))..color(1,rand_color).."}"..p(2,"m 0 0 m 10 20 b 16 20 20 16 20 10 b 20 4 16 0 10 0 b 2 0 0 6 0 10 b 0 16 4 20 10 20")--ESTOS SON LOS EFECTOS 
		l.start_time=line.start_time+syl.start_time
		l.end_time=l.start_time+syl.duration+math.random(200,1000)---CONFIGURACION DEL TIEMPO FINAL DEL EFECTO
...
aegisub.register_macro("Naruto Shippuuden Ending 10 FX KICHAN", "FX CHINGON! :P", fx_kichan)
aegisub.register_filter("Naruto Shippuuden Ending 10 FX KICHAN", "FX CHINGON! :P", 2000, fx_kichan)
