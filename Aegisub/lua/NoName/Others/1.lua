...
l.end_time = l.start_time + syl.duration + 10
l.layer = 2
subs.append(l)
end
...
l.text = string.format("{\\1c&HFFFBCF&\\fade(255,128,0,0,90,90,360)\\fad(10,150)\\pos(%d,%d)\\an5\\bord0\\be1\\frx60\\move\\fscx140\\fscy100\\t(\\be1\\1a&H55&\\fscx180\\fscy140)}{\\p1}m 0 0 m 10 20 b 16 20 20 16 20 10 b 20 4 16 0 10 0 b 2 0 0 6 0 10 b 0 16 4 20 10 20 m 10 1 b 15 1 19 6 19 10 b 18 17 14 19 10 19 b 7 19 2 18 1 10 b 1 6 4 1 10 1 {\\p0}",x,y+12+syl.duration/300,syl.text_stripped)
l.start_time=line.start_time + syl.start_time
l.end_time=l.start_time + syl.duration + KFDS + 145
l.layer = 6
subs.append(l)
...
l.text = string.format("{\\1c&HFFFBCF&\\fade(255,128,0,0,90,90,360)\\fad(10,150)\\pos(%d,%d)\\an5\\1a&H55&\\bord0\\be0.5\\frx60\\move\\fscx140\\fscy100\\t(\\be1\\1a&H55&\\fscx180\\fscy140)}{\\p1}m 0 0 m 10 20 b 16 20 20 16 20 10 b 20 4 16 0 10 0 b 2 0 0 6 0 10 b 0 16 4 20 10 20 m 10 1 b 15 1 19 6 19 10 b 18 17 14 19 10 19 b 7 19 2 18 1 10 b 1 6 4 1 10 1 {\\p0}",x,y+12+syl.duration/300,syl.text_stripped)
l.start_time=line.start_time + syl.start_time
l.end_time=l.start_time + syl.duration + KFDS + 160
l.layer = 7
subs.append(l)


for i=1, #line.kara do
local syl, a = line.kara[k], table.copy(line)
local px = 2
a.layer = 1
a.start_time = line.start_time + syl.start_time
a.end_time = a.start_time + syl.duration
startx, starty = line.left+syl.left - line.styleref.outline, line.top-line.styleref.outline
for y=1, math.ceil((line.height + 2 * line.styleref.outline)/px) do
for x=1, math.ceil((syl.width + 2 * line.styleref.outline)/px) do
posx = startx + (x - 1)*px
posy = starty + (y - 1)*px
rx, ry = math.random(25,35), math.random(-20,-5)
a.text = string.format("{\\move(%d,%d,%d,%d)\\clip(%d,%d,%d,%d)\\t(\\clip(%d,%d,%d,%d))}%s", line.left+syl.center, line.top,line.left+syl.center+rx, line.top+ry, posx, posy, posx+px, posy+px, posx+rx,posy+ry,posx+rx+px,posy+ry+px, syl.text_stripped)
subs.append(a)
end
end
