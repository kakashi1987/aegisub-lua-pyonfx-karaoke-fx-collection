...
DURACION =(line.duration)/Intervalo
end
...
--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
	...
	l = table.copy(line)
	l.text = "{"..fad(200,0)..an(5)..org(x,y)..move(x+rand(100),y-rand(50),x,y)..be(1.5)..bord(0)..frz(100)..color(1,'ffffff')..AutoTimer(TE1,400,'bord',0,0.4,0)..t(frz(300)..estilo(1,line.styleref.color2)..bord(1))..t(frz(0)).."}"..sil() 
	l.start_time = line.start_time -800 +univers
	l.end_time = line.start_time+univers
	l.layer=0 
	subs.append(l) 

		l = table.copy(line)
		l.text = "{"..an(5)..pos(x,y)..estilo(1,line.styleref.color2)..bord(1)..AutoTimer(TE4,500,'frx',20+syl.height/2,0.5,1).."}"..sil() --# OR #--{{~ AutoTimer(TE4,500,'frx',20+line.duration,0.5,1)
		l.start_time = line.start_time+univers
		l.end_time = line.start_time+syl.start_time
		subs.append(l)
		for i=0,2 do
		l = table.copy(line) 
		l.text = "{"..an(5)..fad(0,0)..move(x,y,x,y)..bord(1)..color(1,'H000000')..AutoTimer(TE4,500,'frz',50,0,1).."}"..sil()
	...
	l = table.copy(line)
	l.text = "{"..an(5)..shad(0)..fad(0,100)..bord(1)..pos(x,y)..estilo(1,line.styleref.color4)..AutoTimer(TE4,500,'frx',20+syl.height/2,0.5,1).."}"..sil()
	l.start_time=line.start_time+syl.start_time+syl.duration
	l.end_time=l.end_time+univers+20
	subs.append(l)
